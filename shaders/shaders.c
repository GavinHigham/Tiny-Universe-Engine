...
#include <GL/glew.h>
#include "shaders.h"
const char *effects_vs_file_path[] = {"programs/effects.vs"};
const char *effects_fs_file_path[] = {"programs/effects.fs"};
...
const char *point_light_vs_file_path[] = {"programs/point_light.vs"};
const char *point_light_fs_file_path[] = {"programs/point_light.fs"};
...
const char *deferred_vs_file_path[] = {"programs/deferred.vs"};
const char *deferred_fs_file_path[] = {"programs/deferred.fs"};
...
const char *skybox_vs_file_path[] = {"programs/skybox.vs"};
const char *skybox_fs_file_path[] = {"programs/skybox.fs"};
...
const char *point_light_wireframe_vs_file_path[] = {"programs/point_light_wireframe.vs"};
const char *point_light_wireframe_fs_file_path[] = {"programs/point_light_wireframe.fs"};
...
const char *forward_vs_file_path[] = {"programs/forward.vs"};
const char *forward_fs_file_path[] = {"programs/forward.fs"};
