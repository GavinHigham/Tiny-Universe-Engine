...
int twotri_scene_init()
{
	...
	{
		meter_add("Brightness", 100, 20, 0.0, 250.0, 1000.0);
...
void twotri_scene_update(float dt)
{
	...
	trackball_step(&twotri_trackball, mouse_x, mouse_y, button, scroll_x, scroll_y);
	meter_mouse(mouse_x, mouse_y, button);
}
