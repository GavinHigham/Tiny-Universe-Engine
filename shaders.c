...
#include <GL/glew.h>
#include "shaders.h"
const char *effects_vs_file_path[] = {"shaders/effects.vs"};
const char *effects_fs_file_path[] = {"shaders/effects.fs"};
...
const char *forward_vs_file_path[] = {"shaders/forward.vs"};
const char *forward_fs_file_path[] = {"shaders/forward.fs"};
